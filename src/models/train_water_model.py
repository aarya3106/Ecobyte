"""
Train Water Stress Model
Trains an XGBoost regressor to predict Water Stress scores.
"""
...
def train_model():
    ...
    features = MODEL_FEATURES["water"]
    target = "water_stress_label"
    ...
    print("Fitting Water Stress model...")
    ...
    print("\n" + "="*40)
    print("EVALUATION METRICS (Water Stress Model):")
    ...
    output_path = os.path.join(model_dir, "water_model.json")
    model.save_model(output_path)
    print(f"Saved Water Stress model to {output_path}\n")
