...
Trains an XGBoost regressor to predict Heat Risk scores.
"""
...
def train_model():
    ...
    features = MODEL_FEATURES["heat"]
    target = "heat_risk_label"
    ...
    print("\n" + "="*40)
    print("EVALUATION METRICS (Heat Risk Model):")
    ...
    output_path = os.path.join(model_dir, "heat_model.json")
    model.save_model(output_path)
    print(f"Saved Heat Risk model to {output_path}\n")
